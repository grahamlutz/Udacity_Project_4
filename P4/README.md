...
* Line 11 - Removed link to Google Fonts
* Line 14 - Inlined CSS in <head> 
* Line 57 - Set media query to "print" for 'css/print.css'
* Line 67 - Set Google Analytics script to async
* Line 73, 103 - Used Grunt to compress profile and pizzeria images
